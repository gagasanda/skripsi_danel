...
<body id="page-top">
 ...
 <h3 class="m-0 font-weight-bold text-primary"> SIG KERUSAKAN JALAN </h3>
                    ...
                    <div class="card shadow mb-4">
                                ...
                                <table class="table table-bordered" id="data" name="data" width="100%" cellspacing="0">
                                 ...
                                 <input type="hidden" name="id_data" value="<?php echo $data_jalan['id'];?>">
                                    ...
                                    <button type="submit" name="hapus" class="btn btn-danger" value='hapus' onclick="return confirm('Yakin menghapus data??')">Hapus</button>
                                        
                                    <a href="editdata.php?id=<?php echo $data_jalan['id']; ?>" class="btn btn-primary" >Edit</a></td></tr>
    ...
    <!-- hapus Modal-->
    <div class="modal fade" id="hapus" tabindex="-1" role="dialog" aria-labelledby="test"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button name="logout"  class="btn btn-danger">HAPUS</button>
                    </from>
                </div>
            </div>
        </div>
