                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div>
                                        <a><b>Kondisi   : </b></a>
                                        <br><a><?php echo $adata['kondisi_jalan'] ?></a>
                                </div>
                                ...
                                <div>
                                        <a><b>Keterangan   : </b></a>
                                        <br><a><?php echo $adata['keterangan'] ?></a>
                                </div>
...
<script> 
            ...
            .bindPopup('<Center><b>Lokasi:</b><br><?php echo $data_lokasi['alamat'];?><br><b>Keterangan:</b><br><?php echo $data_lokasi['keterangan'];?><br><br><a class="btn btn-primary rounded-pill">Detail</a>');
            <?php } ?>
